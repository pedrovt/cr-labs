...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \mb_design_fit_timer_0_0_Divide_part__parameterized1_3\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \mb_design_fit_timer_0_0_Divide_part__parameterized1_3\ : entity is "Divide_part";
end \mb_design_fit_timer_0_0_Divide_part__parameterized1_3\;

architecture STRUCTURE of \mb_design_fit_timer_0_0_Divide_part__parameterized1_3\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \mb_design_fit_timer_0_0_Divide_part__parameterized1_4\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \mb_design_fit_timer_0_0_Divide_part__parameterized1_4\ : entity is "Divide_part";
end \mb_design_fit_timer_0_0_Divide_part__parameterized1_4\;

architecture STRUCTURE of \mb_design_fit_timer_0_0_Divide_part__parameterized1_4\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \mb_design_fit_timer_0_0_Divide_part__parameterized1_5\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \mb_design_fit_timer_0_0_Divide_part__parameterized1_5\ : entity is "Divide_part";
end \mb_design_fit_timer_0_0_Divide_part__parameterized1_5\;

architecture STRUCTURE of \mb_design_fit_timer_0_0_Divide_part__parameterized1_5\ is
...
\Using_SRL16s.SRL16s[7].Divide_I\: entity work.\mb_design_fit_timer_0_0_Divide_part__parameterized1_3\
     port map (
      CE => CE_10,
      CE_0 => CE_8,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[8].Divide_I\: entity work.\mb_design_fit_timer_0_0_Divide_part__parameterized1_4\
     port map (
      CE => CE_12,
      CE_0 => CE_10,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[9].Divide_I\: entity work.\mb_design_fit_timer_0_0_Divide_part__parameterized1_5\
     port map (
      CE => CE_12,
      Clk => Clk,
      Clk_En_I_1 => Clk_En_I_1,
...
architecture STRUCTURE of mb_design_fit_timer_0_0 is
  ...
  attribute C_NO_CLOCKS : integer;
  attribute C_NO_CLOCKS of U0 : label is 12500000;
