...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports seven_seg_led_an] [get_bd_intf_pins axi_gpio_display/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO2 [get_bd_intf_ports dual_seven_seg_led_disp] [get_bd_intf_pins axi_gpio_display/GPIO2]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins axi_gpio_display/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  ...
  assign_bd_address -offset 0x40030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_display/S_AXI/Reg] -force
