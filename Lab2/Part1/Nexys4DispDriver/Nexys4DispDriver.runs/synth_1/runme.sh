...
HD_PWD='C:/Users/Pedro/Documents/UA/CR/Labs/Lab2/Nexys4DispDriver/Nexys4DispDriver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nexys4DispDriverWrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nexys4DispDriverWrapper.tcl
