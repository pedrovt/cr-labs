...
HD_PWD='C:/Users/Pedro/Documents/UA/CR/Labs/Lab2/Nexys4DispDriver/Nexys4DispDriver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nexys4DispDriverWrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nexys4DispDriverWrapper.tcl -notrace
